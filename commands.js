...
db.bounties.find({ location: { $all: ["Grasslands"] }});
{
    "_id": {
      "$oid": "65337603b028d7988b9d1d27"
    },
    "name": "Thanoceros",
    "species": "Rhinoceros",
    "location": "Grasslands",
...
db.bounties.find({}, {_id: 1, name:1, species:1, location:1, wantedFor:1, reward:1, captured:1})
{
    "name": "Lokinkajou",
    "species": "Kinkajou",
    "location": "Tropical rainforest",
...
// 2. Remove Lokinkajou
db.bounties.deleteOne({ client: "White tiger" })
{
    acknowledged: true,
    deletedCount: 1
}
